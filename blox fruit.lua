...
local v15 = v14:CreateWindow({
    Title = "hiruZ-HUB-Blox Fruit [ Premium ]",-- free
    SubTitle = "By tu_scriptvn",-- free(premium)
    TabWidth = 160,
    Theme = "Dark",--mĂ u
    Acrylic = false,
...
v23.MouseButton1Down:Connect(function()
    ...
    if not toggled then
        -- Báº­t tráº¡ng thĂ¡i: to + tráº¯ng Ä‘áº·c
        toggled = true
        ...
        -- Táº¯t tráº¡ng thĂ¡i: nhá» + trong nháº¹
        toggled = false
        v23.BackgroundTransparency = 0.5
        v23.BackgroundColor3 = Color3.fromRGB(255,255,255)
                        ...
                        if (v1433:FindFirstChild("Humanoid") and v1433:FindFirstChild("HumanoidRootPart") and (v1433.Humanoid.Health > 0)) then
                            if (v1433.Name == Ms) then
                                repeat
                                    ...
                                    MonFarm = v1433.Name;
                                until not _G.AutoLevel or not v1433.Parent or (v1433.Humanoid.Health <= 0) or not game:GetService("Workspace").Enemies:FindFirstChild(v1433.Name) or (game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == true)
                                bringmob = false;
                            end
                        end
                    end
...
local v58 = v16.Main:AddToggle("ToggleMasteryFruit", {
    Title = "CĂ y ThĂ´ng Tháº¡o TrĂ¡i",
    Description = "",
    Default = false
});
...
if Sea3 then
    ...
    local v501 = v16.Sea:AddToggle("ToggleTPKitsune", {
        Title = "Bay Tá»›i Äáº£o CĂ¡o 9 ÄuĂ´i",
        Description = "",
        Default = false
    });
...
if Sea3 then
    ...
    local v522 = v16.Sea:AddToggle("ToggleTerrorshark", {
        Title = "Äáº­p Cháº¿t Cha TerrorShark",
        Description = "",
        Default = false
    });
    ...
    local v523 = v16.Sea:AddToggle("TogglePiranha", {
        Title = "Äáº­p Cháº¿t Cha CĂ¡ Äiá»‡n",
        Description = "",
        Default = false
    });
    ...
    local v524 = v16.Sea:AddToggle("ToggleShark", {
        Title = "Äáº­p Cháº¿t Cha CĂ¡ Máº­p",
        Description = "",
        Default = false
    });
    ...
    local v525 = v16.Sea:AddToggle("ToggleFishCrew", {
        Title = "Äáº­p Cháº¿t Cha Thuyá»n TrÆ°á»Ÿng Thuyá»n",
        Description = "",
        Default = false
    });
    ...
    local v529 = v16.Main:AddParagraph({
        Title = "Äáº­p Cháº¿t Cha Elite Boss",
        Content = ""
    });
    spawn(function()
        while wait() do
    ...
    function getHighestPoint()
        ...
        for v728, v729 in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v729:IsA("MeshPart") then
                if (v729.MeshId == "rbxassetid://108610659764941") then --thay id áº£nh vĂ o
                    return v729;
                end
            end
        end
...
local v66 = v16.Sea:AddToggle("ToggleTpAdvanced", {
    Title = "Bay tá»›i Ă”ng BĂ¡n TrĂ¡i",
    Description = "",
    Default = false
});
...
local v73 = v16.ITM:AddToggle("ToggleAutoWarden", {
    Title = "Láº¥y Kiáº¿m Quáº£n Ngá»¥c",
    Description = "",
    Default = false
});
...
if Sea3 then
    local v533 = v16.ITM:AddToggle("ToggleHallow", {
        Title = "Láº¥y LÆ°á»¡i HĂ¡i BĂ³ng Tá»‘i",
        Description = "",
        Default = false
    });
    ...
    local v536 = v16.ITM:AddToggle("ToggleHoly", {
        Title = "LĂ m SĂ¡ng Äuá»‘c",
        Description = "Äá»ƒ Láº¥y Tushita",
        Default = false
    });
...
local v77 = v16.ITM:AddToggle("ToggleAutoObservationV2", {
    Title = "Tá»± Äá»™ng Observation V2",
    Description = "",
    Default = false
});
...
local v82 = v16.ITM:AddToggle("ToggleAutoDualKatana", {
    Title = "Tá»± Äá»™ng LĂ m Nhiá»‡m Vá»¥ CDK",
    Description = "",
    Default = false
});
...
if Sea2 then
    local v537 = v16.ITM:AddToggle("ToggleFactory", {
        Title = "ÄĂ¡nh NhĂ  MĂ¡y",
        Description = "YĂªu Cáº§u á»Ÿ Sea 2",
        Default = false
    });
...
local v88 = v16.Setting:AddToggle("ToggleSaveSpawn", {
    Title = "Tá»± Ä‘á»™ng LÆ°u Äiá»ƒm Há»“i Sinh",
    Description = "",
    Default = false
});
...
local v114 = v16.Player:AddToggle("ToggleTeleport", {
    Title = "Dá»‹ch Chuyá»ƒn Tá»›i NgÆ°á»i ChÆ¡i",
    Description = "",
    Default = false
});
...
local v119 = v16.Teleport:AddToggle("ToggleAutoSea2", {
    Title = "Tá»± Äá»™ng Dá»‹ch Chuyá»ƒn Sea 2",
    Description = "",
    Default = false
});
...
local v120 = v16.Teleport:AddToggle("ToggleAutoSea3", {
    Title = "Tá»± Äá»™ng Dá»‹ch Chuyá»ƒn Sea 3",
    Description = "",
    Default = false
});
...
v16.Teleport:AddButton({
    Title = "Dá»‹ch Chuyá»ƒn Tá»›i Äáº£o",
    Description = "",
    Callback = function()
...
local v125 = v16.Fruit:AddToggle("TogglePermanentFruit", {
    Title = "Sá»­ Dá»¥ng TrĂ¡i VÄ©nh Viá»…n",
    Description = "",
    Default = false
});
...
local v126 = v16.Fruit:AddToggle("ToggleStore", {
    Title = "Tá»± Äá»™ng LÆ°u Trá»¯ TrĂ¡i",
    Description = "",
    Default = false
});
...
local v128 = v16.Fruit:AddToggle("ToggleCollectTP", {
    Title = "Dá»‹ch Chuyá»ƒn Tá»›i TrĂ¡i",
    Description = "Risk",
    Default = false
});
...
local v139 = v16.Raid:AddToggle("ToggleStart", {
    Title = "Tá»± Äá»™ng Báº¯t Äáº§u Raid",
    Description = "",
    Default = false
});
...
v16.Race:AddButton({
    Title = "Äáº¿n Äá»n Thá» Thá»i Gian",
    Description = "",
    Callback = function()
...
v16.Race:AddButton({
    Title = "Tá»± Äá»™ng Bay Tá»›i Mua Gear",
    Description = "",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(28286.35546875, 14895.3017578125, 102.62469482421875));
...
local v146 = v16.Race:AddToggle("ToggleKillTrial", {
    Title = "Giáº¿t NgÆ°á»i ChÆ¡i Trial",
    Description = "",
    Default = false
});
...
local v153 = v16.Misc:AddToggle("ToggleAntiBand", {
    Title = "Anti Band",
    Description = "LÆ°u Ă½ NĂ³ Chá»‰ Dá»‹ch Chuyá»ƒn Khi MĂ  Admin VĂ o Game KhĂ´ng Chá»‘ng Ban HoĂ n ToĂ n â ",
    Default = true
});
...
local v155 = v16.Sea:AddToggle("ToggleTPFrozenDimension", {
    Title = "Bay Tá»›i Äáº£o Leviathan",
    Description = "",
    Default = false
});
...
local v158 = v16.Sea:AddToggle("ToggleReceiveQuest", {
    Title = "LĂ m Nhiá»‡m Vá»¥ Blaze Ember",
    Description = "",
    Default = false
});
...
local v159 = v16.Sea:AddParagraph({
    Title = "Tá»± Äá»™ng LĂ m Nhiá»‡m Vá»¥ Blaze Ember",
    Content = ""
});
spawn(function()
    pcall(function()
...
v156:AddButton({
    Title = "Dá»‹ch Chuyá»ƒn Tá»›i NPC Dragon Dojo",
    Description = "",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(5661.5322265625, 1013.0907592773438, - 334.9649963378906));
        Tween2(CFrame.new(5814.42724609375, 1208.3267822265625, 884.5785522460938));
...
v156:AddButton({
    Title = "Cháº¿ Táº¡o Volcano Magent",
    Description = "",
    Callback = function()
        local v395 = {
            [1] = "CraftItem",
...
local v164 = v16.Sea:AddToggle("ToggleCollectFireFlowers", {
    Title = "TĂ¬m Hoa Lá»­a",
    Description = "Láº¥y Tá»™c Dragon V2",
    Default = false
});
...
local v170 = v16.Sea:AddToggle("ToggleTPVolcano", {
    Title = "Bay Tá»›i Prehistoric Island",
    Description = "",
    Default = false
});
...
local v176 = v16.Sea:AddToggle("ToggleCollectBone", {
    Title = "Nháº·t XÆ°Æ¡ng Prehistoric Island",
    Description = "",
    Default = false
});
...
local v177 = v16.Sea:AddToggle("ToggleCollectEgg", {
    Title = "Nháº·t Trá»©ng Prehistoric Island",
    Description = "",
    Default = false
});
